...
export default async function handler(req, res) {
  ...
  try {
    // process.env.DATABASE_URL es la variable que configurarás en Vercel
    const sql = neon(process.env.ostgresql://neondb_owner:npg_3BciRG2ZXVbW@ep-calm-band-aii60ffa-pooler.c-4.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require);

    // Ejecutamos las tres consultas en paralelo en el servidor (Seguro)
